...
export interface ApiPaymentCallBackPaymentCallBack
  extends Schema.CollectionType {
  collectionName: 'payment_call_backs';
  info: {
    singularName: 'payment-call-back';
    pluralName: 'payment-call-backs';
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::payment-call-back.payment-call-back': ApiPaymentCallBackPaymentCallBack;
